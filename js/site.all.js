 ...
 * @author: Matthew Smith
 ...
 <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
  ...
  <input type="hidden" name="item_name" value="Respond Commercial License">
...
var payWhatever = (function() {
  ...
  for(x=0; x<els.length; x++) {
    els[x].addEventListener('click', function() {
      ...
      // setup
      logo = 'http://beta.respondcms.com/resources/respond-paypal-logo.png';
			email = 'matt@matthewsmith.com';
			currency = 'USD';
			returnUrl = 'http://beta.respondcms.com/download-now';
			cancelUrl = 'http://beta.respondcms.com/download';
			useSandbox = false;
        ...
        // data setup
  			data = {
  				...
  				'image_url': logo,
  				'item_name': 'Respond Commercial License',
  				'quantity': 1,
